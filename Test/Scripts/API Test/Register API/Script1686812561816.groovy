...
def stringBody = bodyString

ResponseObject postResponse = WS.sendRequest(findTestObject('Register account', [('body') : stringBody]))
...
'Assert message'
Assertions.assertThat(afterParsing.message).isEqualTo(message)
