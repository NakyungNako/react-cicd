...
WebUI.setText(findTestObject('Object Repository/Page_React App/input_Username_username'), username)
...
WebUI.click(findTestObject('Object Repository/Page_React App/div_account1'))
