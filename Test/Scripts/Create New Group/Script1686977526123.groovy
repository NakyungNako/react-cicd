...
WebUI.click(findTestObject('Object Repository/Page_React App/button_Add a Group'))

WebUI.setText(findTestObject('Object Repository/Page_React App/input_Create Presentation_MuiInputBase-inpu_4e309c'), 'testgroup2')
