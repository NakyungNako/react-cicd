...
WebUI.click(findTestObject('Object Repository/Page_React App/Page_React App/button_account1_MuiButtonBase-root MuiIconB_fe1af3'))

WebUI.click(findTestObject('Object Repository/Page_React App/Page_React App/li_Leave Group'))

WebUI.verifyTextNotPresent('testgroup2', false)
