...
WebUI.setText(findTestObject('Page_React App/input_Username_username'), 'account2')
...
WebUI.click(findTestObject('Page_React App/Page_React App/li_Make Admin'))

WebUI.click(findTestObject('Page_React App/Page_React App/button_account3'))

WebUI.click(findTestObject('Object Repository/Page_React App/Page_React App/li_Remove Member'))

WebUI.verifyTextNotPresent('account3', false)
